...
//11487366/1260192/2.50/2/5/Resistor
...
(library Library_1
	...
	(symbolDef "CR0402-FX-2943GLF" (originalName "CR0402-FX-2943GLF")
	...
	(compDef "CR0402-FX-2943GLF" (originalName "CR0402-FX-2943GLF") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CR0402-FX-2943GLF"))
		...
		(attr "Mouser Part Number" "652-CR0402FX2943GLF")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=652-CR0402FX2943GLF")
		(attr "Manufacturer_Name" "Bourns")
		(attr "Manufacturer_Part_Number" "CR0402-FX-2943GLF")
		(attr "Description" "Thick Film Resistors - SMD CHIP RESISTOR")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/CR0402-FX-2943GLF.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "CR0402-FX-2943GLF.stp")
