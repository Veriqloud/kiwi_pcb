...
(library Library_1
	...
	(patternDef "CCG304815S" (originalName "CCG304815S")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 9.630, -10.160) (textStyleRef "Normal") (isVisible True))
		)
	...
	(compDef "CCG30-24-12D" (originalName "CCG30-24-12D") (compHeader (numPins 6) (numParts 1) (refDesPrefix PS)
		...
		(compPin "1" (pinName "RC") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://product.tdk.com/system/files/dam/doc/product/power/switching-power/dc-dc-converter/catalog/ccg_e.pdf")
		(attr "<Component Height>" "9.9")
		(attr "<STEP Filename>" "CCG30-24-12D.stp")
		(attr "<STEP Offsets>" "X=10.15;Y=-10.16;Z=0")
