...
//11430650/1260192/2.50/2/3/Resistor
...
(library Library_1
	...
	(compDef "RC0402FR-07100RL" (originalName "RC0402FR-07100RL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		...
		(attr "Description" "ic")
		(attr "<Hyperlink>" "https://www.yageo.com/upload/media/product/productsearch/datasheet/rchip/PYu-RC_Group_51_RoHS_L_10.pdf")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "RC0402FR-07100RL.stp")
