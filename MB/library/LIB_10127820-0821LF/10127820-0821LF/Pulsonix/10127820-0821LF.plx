...
//18766028/1260192/2.50/8/2/Connector
...
(library Library_1
	...
	(patternDef "101278200821LF" (originalName "101278200821LF")
		(multiLayer
			(pad (padNum 1) (padStyleRef s210_h140) (pt -0.000, 0.000) (rotation 90))
			(pad (padNum 2) (padStyleRef c210_h140) (pt 4.200, 0.000) (rotation 90))
			(pad (padNum 3) (padStyleRef c210_h140) (pt 8.400, 0.000) (rotation 90))
			(pad (padNum 4) (padStyleRef c210_h140) (pt 12.600, 0.000) (rotation 90))
			(pad (padNum 5) (padStyleRef c210_h140) (pt -0.000, -5.500) (rotation 90))
			(pad (padNum 6) (padStyleRef c210_h140) (pt 4.200, -5.500) (rotation 90))
			(pad (padNum 7) (padStyleRef c210_h140) (pt 8.400, -5.500) (rotation 90))
			(pad (padNum 8) (padStyleRef c210_h140) (pt 12.600, -5.500) (rotation 90))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 6.300, -2.750) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.7 2.125) (pt 15.3 2.125) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 15.3 2.125) (pt 15.3 -7.625) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 15.3 -7.625) (pt -2.7 -7.625) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.7 -7.625) (pt -2.7 2.125) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt -2.7 2.125) (pt 15.3 2.125) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 15.3 2.125) (pt 15.3 -7.625) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 15.3 -7.625) (pt -2.7 -7.625) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -2.7 -7.625) (pt -2.7 2.125) (width 0.2))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -3.7 3.125) (pt 16.3 3.125) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 16.3 3.125) (pt 16.3 -8.625) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 16.3 -8.625) (pt -3.7 -8.625) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -3.7 -8.625) (pt -3.7 3.125) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(symbolDef "10127820-0821LF" (originalName "10127820-0821LF")
	...
	(compDef "10127820-0821LF" (originalName "10127820-0821LF") (compHeader (numPins 8) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "10127820-0821LF"))
		(attachedPattern (patternNum 1) (patternName "101278200821LF")
			(numPads 8)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "10127820-0821LF")
		(attr "Description" "Minitek<sup></sup> Pwr 4.2, Dual Row, Vertical Through Hole Header, Gold Flash plating, Natural Color, 8 Positions, Non GW Compatible Nylon66, Tray Packing.")
		(attr "<Hyperlink>" "https://cdn.amphenol-cs.com/media/wysiwyg/files/drawing/10127820.pdf")
		(attr "<Component Height>" "14.65")
		(attr "<STEP Filename>" "10127820-0821LF.stp")
